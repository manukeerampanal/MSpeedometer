...
document.addEventListener ("DOMContentLoaded", function() {
  ...
  mspeedometer = new MSpeedometer ('mspeedometer', {theme: 'default'});
  mspeedometer.draw ();
});
</code></pre>
...
* Float *end_value*: initial value on the scale - _default *0.0*_
...
* String *titletext*: Text for setting the title for the mspeedometer - _default *null*_
* Integer *titlex*: x-axis for title text of the meter scale - _default *0*_
* Integer *titley*: y-axis for title text of the meter scale - _default *0*_

h2. Components

!http://manu.co.in/mspeedometer/doc/configuration.png!
